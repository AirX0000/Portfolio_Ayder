...
const Experience = () => {
    return (
        <Section id="experience">
            <h2 className="text-4xl font-cyber text-white mb-16 text-center">Work <span className="text-neon">Experience</span></h2>
                ...
                <div className="space-y-12">
                    ...
                    {experiences.map((exp, index) => (
                        <div key={index} className={`relative flex items-center justify-between md:justify-normal w-full group mb-8 ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                            {/* Dot */}
                            <div className="absolute left-[5px] md:left-1/2 w-4 h-4 rounded-full bg-dark border-2 border-neon md:-translate-x-1/2 z-10 box-content"></div>
